...
(function () {
     ...
     */
    var URL = window.UEDITOR_HOME_URL || "/SkinManage/jslib/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"http://ofoqjde8z.bkt.clouddn.com/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //七牛结合需要改成file
        ...
        //图片在线管理配置区
        ,imageManagerUrl: "/SkinManage/qiniu/imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:"http://ofoqjde8z.bkt.clouddn.com/"                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'fontsize', 'bold', 'italic', 'forecolor', 'insertorderedlist',
                'insertunorderedlist', 'blockquote', 'simpleupload', 'insertimage', 'insertvideo', 'link', 'justifyleft', 'justifycenter', 'justifyright', 'preview', 'undo', 'redo']
        ]
        /*, toolbars:[
